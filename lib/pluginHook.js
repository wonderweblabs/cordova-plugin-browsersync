...
module.exports = function(context) {
    ...
    platforms = platforms.filter(function(name) {
      return context.opts.platforms.indexOf(name) != -1;
    });
    ...
    var bs = browserSyncServer(function(defaults) {
        ...
        platforms.forEach(function(platform) {
            ...
            defaults.server.routes['/' + www.replace(/\\/g, '/')] = path.join(context.opts.projectRoot, www);
        });
